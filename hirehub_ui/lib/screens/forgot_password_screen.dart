...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _handleAction() async {
    ...
    if (ok) {
      ...
      _snack(auth.errorMessage ?? 'Failed to reset password', DangerColor.c500);
    }
  }
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Icon(Icons.lock_reset_rounded, size: 42, color: BrandColor.c500),
                ),
              ),
              ...
              Center(
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      const TextSpan(text: 'Reset ', style: TextStyle(fontWeight: FontWeight.w700)),
                      TextSpan(
                        text: 'Password',
                        style: TextStyle(color: NeutralColor.c500, fontWeight: FontWeight.w400),
                      ),
                    ],
                  ),
                ),
                            ...
                            child:
                                auth.isLoading
                                    ...
                                    : CustomButton(
                                      ...
                                      text: !_otpSent ? 'Send OTP' : 'Reset Password',
  ...
  Widget _buildField({
    ...
    return CustomTextFormField(
      ...
      style: TextStyle(
        ...
        color: enabled ? NeutralColor.c900 : NeutralColor.c500,
      ),
      hintText: label,
          ...
          children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: active ? BrandColor.c500 : Colors.transparent,
                  width: 2,
                ),
              ),
              child: Center(
