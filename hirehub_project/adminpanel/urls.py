...
urlpatterns = [
    ...
    #job/company management
     ...
     path('api/forgot-password/send-otp/', views.ForgotPasswordSendOTPAPI.as_view(), name='api_forgot_password_send_otp'),
     path('api/forgot-password/reset/', views.ResetPasswordAPI.as_view(), name='api_forgot_password_reset'),
